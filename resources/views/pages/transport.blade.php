            ...
            <div class="kingster-page-wrapper" id="kingster-page-wrapper">
                ...
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 390px ;padding-bottom: 55px ;">
                        ...
                        <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;">Transport Updates</h1></div>
                </div>
            </div>
            <div class="kingster-breadcrumbs">
                <div class="kingster-breadcrumbs-container kingster-container">
                    <div class="kingster-breadcrumbs-item kingster-item-pdlr"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Kingster." href="index-2.html" class="home"><span property="name">Home</span></a>
                        ...
                        </span>&gt;<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Bachelor Of Science in Business Administration." href="index-2.html" class="post post-page"><span property="name">Ugandans in the Diaspora / Transport Updates    </span></a>
                                    ...
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                            <div class="gdlr-core-title-item-title-wrap clearfix">
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 24px ;font-weight: 700 ;letter-spacing: 0px ;text-transform: none ;color: #293a5b ;">Entebbe International Airport Set to Open on October 1, 2020</h3></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 15px ;">
                                            <div class="gdlr-core-text-box-item-content" style="font-size: 21px ;text-transform: none ;color: #163269 ;">
                                                <p><time datetime="2016-11-26T15:04:44+00:00"> <h6><i class="fa fa-calendar"> Posted on September 10, 2020 </i> <i class="fa fa-user"> Admin</i></h6> </time></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                    ...
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px ;">
                                            <div class="gdlr-core-text-box-item-content" style="font-size: 15px ;text-transform: none ; text-align: justify">
                                                <p>International commercial passenger flights return to Uganda’s Entebbe International Airport on October 1, 2020, ending at least five months of lockdown occasioned by the Covid-19 pandemic.</p>
                                                <p>The Uganda Civil Aviation Authority (UCAA) in a September 8 letter to airlines’ executives said that 13 flights, to and from the airport have been cleared for the first day, while 10 flights are confirmed for the second day. The letter is signed by Sooma Ayub, the UCAA director for Airports and Aviation security.</p>
                                                <p>Airlines expected to resume flights in Uganda include the national carrier Uganda Airlines, Kenya Airways, Qatar Airways, Air Tanzania, Ethiopian Airlines, FlyDubai, RwandAir, KLM, Turkish Airlines, Emirates, Brussels Airlines, and Tarco Aviation.</p>
                                                <p>The UCAA says the reopening will see the number of flights handled at the airport increasing gradually. The regulator also gave details of a revised weekly flight schedule for the first phase of the reopening which runs for three months. Entebbe International Airport was closed to passenger traffic since March except for evacuation and repatriation flights and cargo. The closure hit hard sectors like tourism which rely on aviation</p>
                                                <p>The news comes as relief to our over 200 companies that had lost business and a lot of employees had been laid off. We will now embark on our mission to promote safer migration and curb unemployment in the country.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-tab-item gdlr-core-js gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-tab-style1-horizontal gdlr-core-item-pdlr">
                                            <div class="gdlr-core-tab-item-wrap">
                                                <div class="gdlr-core-tab-item-title-wrap clearfix gdlr-core-title-font">
                                                    <div class="gdlr-core-tab-item-title  gdlr-core-active" data-tab-id=""><a href="/airport">Airport</a></div>
                                                    <div class="gdlr-core-tab-item-title " data-tab-id=""><a href="/jobs">Emloyment</a></div>
                                                    <div class="gdlr-core-tab-item-title " data-tab-id=""><a href="/lockdown">Lockdown</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-button-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 55px ;"><a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border gdlr-core-column-30" href="/consultancy-finance-auditor" style="font-size: 14px ;font-weight: 700 ;letter-spacing: 0px ;padding: 13px 29px 18px 32px;text-transform: none ;margin: 0px 10px 10px 0px;border-radius: 2px;-moz-border-radius: 2px;-webkit-border-radius: 2px;"><span class="gdlr-core-content" >⟵ Consultancy: External Finance Auditor</span></a><a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border gdlr-core-column-30" href="/sops" style="font-size: 14px ;font-weight: 700 ;letter-spacing: 0px ;padding: 13px 29px 18px 32px;text-transform: none ;border-radius: 2px;-moz-border-radius: 2px;-webkit-border-radius: 2px;"><span class="gdlr-core-content" >Here are the Standard Operating Procedures (SOPs) for departing and arriving passengers at Entebbe International Airport. #Covid19 ⟶</span></a></div>
                                    </div>
                                </div>
                            </div>
