            ...
            <div class="kingster-page-wrapper" id="kingster-page-wrapper">
                ...
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 390px ;padding-bottom: 55px ;">
                        ...
                        <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;">Meeting | UAERA -Board</h1></div>
                </div>
            </div>
                                    ...
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px ;">
                                            <div class="gdlr-core-text-box-item-content" style="font-size: 15px ;text-transform: none ; text-align: justify">
                                                <p>Today, our Board held a meeting with the Ministry of Finance Planning and Economic Development (MOFPED) and the department of National economy under MOFPED together with Uganda Revenue Authority (URA) team that handles policy. The following have been the outcomes of the discussions:1) We explained the recruitment process and the industry at large. 2) Migrant […]</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
